...
Skills auto-load when detected in your work. **copilot should proactively load them:**
- `/task-workflow` when: creating `.copilot/tasks/*.md`, promoting tasks, checking merge readiness, or working on task-related operations
...
**Task workflow:** Create `<type>_<short-description>.md` in `.copilot/tasks/` with Status/Goal/Acceptance Criteria/Plan before any code.
