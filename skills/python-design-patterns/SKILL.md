...
2. One reason to change per unit
3. Distinct layers with clear ownership
4. Compose, don't inherit
5. Wait before abstracting (Rule of Three)
6. 20–50 lines, one purpose per function
7. Constructor injection for testability
8. Delete dead code before considering abstractions
9. Test each layer in isolation
